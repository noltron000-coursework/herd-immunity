class Logger(object):
	...
	# PROTIP:
	# Write your tests before you solve each function, that way you can test them one by one as you write your class.
	...
	def write_metadata(self, pop_size, vacc_percentage, virus_name, mortality_rate, basic_repro_num):
		...
		# For all other methods, use the 'a' mode to append a new log to the end, since 'w' overwrites the file.

		# NOTE:
		# Make sure to end every line with a '/n' character to ensure that each event logged ends up on a separate line!
		pass
	...
	def log_interaction(self, person, random_person, random_person_sick=None, random_person_vacc=None, did_infect=None):
		...
		# TODO:
		# Finish this method.
		# Think about how the booleans passed (or not passed) represent all the possible edge cases.
		# Use the values passed along with each person, along with whether they are sick or vaccinated when they interact, to determine exactly what happened in the interaction.
	...
	def log_time_step(self, time_step_number):
		...
		If you choose to extend this method, the format of the summary statistics logged are up to you.
