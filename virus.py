class Virus:
	...
	def __init__(self, name, reproduction_num, mortality_num):
		'''
		Sets up the virus to include the name of the virus,
		the reproduction number that controls how infectious it is,
		and the mortality rate or how deadly it is
		'''
